...
## Exercise
1. Generate your Akamai API credentials following the steps above. Practice setting them as environment variables or in an `.edgerc` file. Verify that you can access your Akamai account programmatically using these credentials.