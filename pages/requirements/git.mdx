...
> Note: If you are a Windows user, make sure to run the commands below in PowerShell, rather the Cmd Prompt. You do not need Runas Administrator unless specified
