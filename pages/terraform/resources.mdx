...
1. Create a terraform file with at least one resource
2. Create a 2nd resource which refers back to some element of the first, using its address

_Try not to just copy the example above, as that is way too easy :-) Come up with some new use case of your own_