...
Just like with the resources `data_source_type` comes from your provider and `data_source_instance` is the name or label you use for the _instance_ and must be unique.
