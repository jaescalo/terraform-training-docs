...
1. Create a file named `provider.tf`. Populate it as the example above
...
> Note: Save this file for later. It is useful to copy into any new folder in which you are configuring Terraform